      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            ...
            if ((templateSpec.name === 'blank' || templateSpec.name === 'tabs' || templateSpec.name === 'bare-minimum' || templaceSpec.name === 'bare-foundation') && templateSpec.registry) {
            ...
            return (0, (_prompt || _load_prompt()).default)({
              ...
              choices: FEATURED_TEMPLATES.map(function (template) {
                if (typeof template === 'string') {
                  ...
                  return {
                    value: template.name,
                    name: (_chalk || _load_chalk()).default.bold((0, (_padEnd || _load_padEnd()).default)(template.shortName, descriptionColumn)) + (0, (_wordwrap || _load_wordwrap()).default)(descriptionColumn + 2, process.stdout.columns || 80)(template.description).trimStart(),
                    short: template.name
                  };
                }
              })
